            ...
            <div className="flex flex-col md:mt-auto">
                <div className="hidden md:flex flex-col" id="landing-text">
                    <div className="flex flex-row justify-between items-end">
                        ...
                        <p style={dirtyline.style} className="text-[20px] md:text-[3rem] lg:text-[4rem] 2xl:text-[5.5rem]">Digital</p>
                    </div>
                    <div className="flex flex-row justify-between items-end">
                        <p style={dirtyline.style} className="text-[20px] md:text-[3rem] lg:text-[4rem] 2xl:text-[5.5rem]">Bedanta</p>
                        <p style={dirtyline.style} className="text-[20px] md:text-[3rem] lg:text-[4rem] 2xl:text-[5.5rem] text-[#FF4900]">Designer</p>
                    </div>
                    <div className="flex flex-row justify-between items-end">
                        <p style={dirtyline.style} className="text-[20px] md:text-[3rem] lg:text-[4rem] 2xl:text-[5.5rem]">Rick</p>
                        {/* <div className="border-b-2 border-white w-96"></div> */}
                        <p style={dirtyline.style} className="text-[20px] md:text-[3rem] lg:text-[4rem] 2xl:text-[5.5rem] whitespace-nowrap">Creative Enthusiast</p>
                    </div>
                </div>
