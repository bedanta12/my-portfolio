...
export default function ContactPage() {
    ...
    return (
        <div id="contact-fancy-text" className={`overflow-hidden bg-[#FFF8F8] dark:bg-[#121212]`}>
            ...
            <div className="flex flex-col pt-6 pb-10 pl-12 pr-40 gap-4 items-start">
                <svg onClick={togglePopup} width="33" height="33" viewBox="0 0 33 33" className="dark:fill-[#FFF8F8] fill-[#121212] hover:cursor-pointer">
                ...
                <div className="grid grid-rows-5 grid-cols-5 grid-flow-row gap-x-40 gap-y-2">
                    <div>

                    </div>
                    <div className="flex items-end text-[14px] text-[#121212] dark:text-[#EAEAEA] text-opacity-70 dark:text-opacity-70 col-span-3">
                        Play area
                    </div>
                    <div className="flex items-end text-[14px] text-[#121212] dark:text-[#EAEAEA] text-opacity-70 dark:text-opacity-70">
                        Follow
                    </div>
                    <div id="contact-fancy-text" className="text-2xl ">
                        Bedanta.design
                    </div>
                    <div id="contact-fancy-text" style={dirtyline.style} className="text-[38px] flex flex-col col-span-3 mb-14">
                        <span>
                        Let's connect 
                        </span>
                        <span>
                    ...
                    <div className="flex flex-col justify-between items-start text-[18px] mb-14">
                        <div id="contact-fancy-text" className='flex flex-col gap-2'>
                    ...
                    <div className='text-[18px] flex flex-col col-span-3 mb-14 gap-2'>
                        <span>
                        Email Address
                        </span>
                    ...
                    <div style={dirtyline.style} className="text-[48px]">
                        @2023
                    </div>
                    <div className='col-span-3'>
                        <svg width="240" height="40" viewBox="0 0 240 40" className="dark:fill-[#FFF8F8] fill-[#121212]">
                            <rect x="53.6879" y="16.4258" width="5.1711" height="7.90875" rx="2.58555" />
                            <rect x="111.483" y="16.4258" width="5.1711" height="7.90875" rx="2.58555" />
                            <rect x="127.604" y="16.4258" width="5.1711" height="7.90875" rx="2.58555" />
                            <rect x="168.973" y="16.4258" width="5.1711" height="7.90875" rx="2.58555" />
                            <rect x="218.403" y="16.4258" width="5.1711" height="7.90875" rx="2.58555" />
                            <rect x="234.829" y="16.4258" width="5.1711" height="7.90875" rx="2.58555" />
                            <rect x="61.5967" y="13.6882" width="5.47529" height="12.7757" rx="2.73764" />
                            <rect x="136.121" y="13.6882" width="5.47529" height="12.7757" rx="2.73764" />
                            <rect x="69.8096" y="9.27759" width="5.47529" height="21.597" rx="2.73764" />
                            <rect x="160.608" y="11.4067" width="5.47529" height="17.3384" rx="2.73764" />
                            <rect x="201.825" y="11.4067" width="5.47529" height="17.3384" rx="2.73764" />
                            <rect x="210.19" y="11.4067" width="5.47529" height="17.3384" rx="2.73764" />
                            <rect x="119.391" y="9.27759" width="5.47529" height="21.597" rx="2.73764" />
                            <rect x="177.034" y="9.27759" width="5.47529" height="21.597" rx="2.73764" />
                            <rect x="185.399" y="9.27759" width="5.47529" height="21.597" rx="2.73764" />
                            <rect x="78.3267" y="4.86694" width="5.01901" height="30.5703" rx="2.50951" />
                            <rect x="152.699" y="4.86694" width="5.01901" height="30.5703" rx="2.50951" />
                            <rect x="226.92" y="4.86694" width="5.01901" height="30.5703" rx="2.50951" />
                            <rect x="86.5396" y="2.12939" width="5.01901" height="36.0456" rx="2.50951" />
                            <rect x="94.9047" y="2.12939" width="5.01901" height="36.0456" rx="2.50951" />
                            <rect x="193.916" y="2.12939" width="5.01901" height="36.0456" rx="2.50951" />
                            <rect x="103.27" y="0.1521" width="5.01901" height="39.8479" rx="2.50951" />
                            <rect x="144.334" y="0.1521" width="5.01901" height="39.8479" rx="2.50951" />
                            <svg width="40" height="40" viewBox="0 0 496 512"><path fill="currentColor" d="M248 8C111.1 8 0 119.1 0 256s111.1 248 248 248s248-111.1 248-248S384.9 8 248 8zm100.7 364.9c-4.2 0-6.8-1.3-10.7-3.6c-62.4-37.6-135-39.2-206.7-24.5c-3.9 1-9 2.6-11.9 2.6c-9.7 0-15.8-7.7-15.8-15.8c0-10.3 6.1-15.2 13.6-16.8c81.9-18.1 165.6-16.5 237 26.2c6.1 3.9 9.7 7.4 9.7 16.5s-7.1 15.4-15.2 15.4zm26.9-65.6c-5.2 0-8.7-2.3-12.3-4.2c-62.5-37-155.7-51.9-238.6-29.4c-4.8 1.3-7.4 2.6-11.9 2.6c-10.7 0-19.4-8.7-19.4-19.4s5.2-17.8 15.5-20.7c27.8-7.8 56.2-13.6 97.8-13.6c64.9 0 127.6 16.1 177 45.5c8.1 4.8 11.3 11 11.3 19.7c-.1 10.8-8.5 19.5-19.4 19.5zm31-76.2c-5.2 0-8.4-1.3-12.9-3.9c-71.2-42.5-198.5-52.7-280.9-29.7c-3.6 1-8.1 2.6-12.9 2.6c-13.2 0-23.3-10.3-23.3-23.6c0-13.6 8.4-21.3 17.4-23.9c35.2-10.3 74.6-15.2 117.5-15.2c73 0 149.5 15.2 205.4 47.8c7.8 4.5 12.9 10.7 12.9 22.6c0 13.6-11 23.3-23.2 23.3z"/></svg>
                        </svg>
                    </div>
                    <div className='flex flex-row items-end gap-4'>
                        ...
                        <span className='whitespace-nowrap text-xs border rounded-full px-2'>
                            Time to talk
                        </span>
                    </div>
                </div>
